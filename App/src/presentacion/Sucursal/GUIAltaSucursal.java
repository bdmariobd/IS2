package presentacion.Sucursal;
	...
	public class GUIAltaSucursal extends JFrame {
		...
		private String[] labels = {"Insertar ID","Insertar ciudad","Insertar telefono", "Insertar direccion" };
			...
			public void actionPerformed(ActionEvent e) {
				for(int i=0;i<labels.length;i++) { // Menos uno por que danos que es la ultima puede ser vacia,jjaja aqui no salu2
					if(inputs[i].getText().isEmpty()) {
						JOptionPane.showMessageDialog(null, "ID, ciudad, telefono y direccion no pueden estar vacias","ERROR",JOptionPane.ERROR_MESSAGE);
						return;
					}
				}
